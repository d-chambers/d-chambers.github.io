---
title: "Rockbursts, Lasers, and Glass Tubes"
# title: "The Sound of Rockbursts"
description: "A New Monitoring Approach for Longwall Coal Mines"
author: 
  - "Derrick Chambers"
  - "Shawn Boltz"
date: "04/01/2023"
...
Rockbursts, or bursts, are violent, dynamic failures which occur in deep underground mines.
Bursts pose a significant threat to miners and operations, and, much like earthquakes,
they can release significant amounts of energy and are notoriously difficult to predict.

For hardrock mines, however, seismic monitoring has proven invaluable for understanding
and managing burst-related risks. Very few, if any, deep underground hardrock mines operate 
...
- Coal mines tend to produce many more events than hardrock mines.

To help overcome these challenges, we developed a new approach to monitor bursts occurring
near the longwall face using fiber-optic cable.
...
:::{.note}
If you are not familiar with longwall mining [this video](https://www.youtube.com/watch?v=HHaUypSqdzM)
provides a visual introduction.
:::
...
strains which occur in standard fiber-optic cable. DAS has been used extensively in the oil and gas 
industry, and for other geophysical purposes [@lindsey2021fiber],
but is only starting to find applications in mining.
...
cable wrapped around thin-walled plastic cylinders. The monitoring array is physically attached 
to the mining equipment, so it requires minimal re-configuration as mining advances.
...
Unlike traditional monitoring approaches, the electronics can be deployed kilometers away from the
monitoring site and the array itself is simply composed of standard fiber-optic cables, eliminating 
...
![
Data recorded by the seismoacoustic array. The blue channels were recorded by lead cables and
the orange channels were recorded by the microphones.
](images/waveforms.png)

The lead cables (blue) tend to record more impulsive, shorter duration signals across the entire
array whereas the microphones (orange) record emergent, long duration signals on a few channels
close to the event damage.

# Monitoring Implications

The array overcomes many of the shortcomings of traditional in-mine seismic monitoring for
coal mines: sensors move with the mining front, and since permissible fiber-optic cable is used
for the sensing elements, there are no restrictions on its placement.

Additionally, the array records near-field data (sounds and vibrations) associated with burst damage.
These types of recordings may provide better information about the extent and mechanisms of the damage,
volume and velocities of ejected rock, and gas liberation than far-field recordings from seismic sensors alone.

However, before this type of monitoring can be routinely conducted in longwall mines, several
improvements are needed. First, the longwall environment is extremely harsh so
careful consideration must be given to how the array is attached to the longwall and the grade
of cable used to create the array. Second, the longwall face is extremely noisy with cutting, moving
...
in underground mines in the future. Here we have demonstrated a monitoring strategy
for monitoring bursts occurring near the mining face at underground longwall mines. 
